...
func (h *v1header) getIfaceIndex() int {
	ll := (*unix.SockaddrLinklayer)(unsafe.Pointer(uintptr(unsafe.Pointer(h)) + uintptr(tpAlign(unix.SizeofTpacketHdr))))
...
func (h *v2header) getIfaceIndex() int {
	ll := (*unix.SockaddrLinklayer)(unsafe.Pointer(uintptr(unsafe.Pointer(h)) + uintptr(tpAlign(unix.SizeofTpacket2Hdr))))
	return int(ll.Ifindex)
}
...
func (w *v3wrapper) getIfaceIndex() int {
	ll := (*unix.SockaddrLinklayer)(unsafe.Pointer(uintptr(unsafe.Pointer(w.packet)) + uintptr(tpAlign(unix.SizeofTpacket3Hdr))))
	return int(ll.Ifindex)
}
